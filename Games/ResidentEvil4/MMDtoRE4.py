...
# 安装方法：将脚本直接放到blender路径下的脚本文件夹（addons）中，然后在blender偏好设置中勾选启用脚本即可。
...
class MMDtoRE4Rename(bpy.types.Operator):
    bl_idname = "tool.mmdtore4rename"
    bl_label = "MMD to RE4(undo)"
