...
def register_all(__bl_classes) -> None:
    _register_classes(__bl_classes)
...
def unregister_all(__bl_classes) -> None:
    _unregister_classes(__bl_classes)
    unload_smc_icons()
    #addon_updater_ops.unregister()
    extend_types.unregister()


def _register_classes(__bl_classes) -> None:
    count = 0
...
def _unregister_classes(__bl_classes) -> None:
    count = 0
