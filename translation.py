...
translation_dict = {
    ...
    "zh_CN": {
        ...
        ("Operator", "separate by materials (need CATS)"): "按材质分离（需要CATS插件）",
        ("Operator", "clean zero weight vg"): "清除空顶点组",

        #Universal translation
        ("*", "make sure you select mmd armature first and then the game armature in the object mode"): "请确保在物体模式下先选中mmd骨架，再选中游戏骨架",
        ...
        #("*", "batch add empty meshes with properties"): "批量添加带自定义属性的空模型网格",
        #("Operator", "add empty mesh"): "添加空模型网格",
